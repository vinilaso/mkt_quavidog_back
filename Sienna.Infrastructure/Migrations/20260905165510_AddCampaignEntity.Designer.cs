...
namespace Sienna.Infrastructure.Migrations
{
    ...
    [Migration("20260905165510_AddCampaignEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sienna.Domain.Entities.Media.Media", b =>
                {
                    ...
                    b.ToTable("MEDIA_MEDIAS", (string)null);
                });
            ...
            modelBuilder.Entity("Sienna.Domain.Entities.Workflow.Campaign", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("ID");
                    ...
                    b.ToTable("WORKFLOW_CAMPAIGNS", (string)null);
                });
            ...
            modelBuilder.Entity("Sienna.Domain.Entities.Workflow.Team", b =>
                {
                    ...
                    b.ToTable("WORKFLOW_TEAMS", (string)null);
                });
            ...
            modelBuilder.Entity("Sienna.Domain.Entities.Workflow.TeamMember", b =>
                {
                    ...
                    b.ToTable("WORKFLOW_TEAM_MEMBERS", (string)null);
                });
            ...
            modelBuilder.Entity("Sienna.Domain.Entities.Media.Post", b =>
                {
                    b.HasOne("Sienna.Domain.Entities.Identity.User", "Author")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("Sienna.Domain.Entities.Workflow.Campaign", b =>
                {
                    b.HasOne("Sienna.Domain.Entities.Workflow.Team", "Team")
                        .WithMany("Campaigns")
